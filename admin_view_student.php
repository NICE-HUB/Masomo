            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <img src="home/images/Sonal Gharti.jpg" alt=""><?php echo "{$info['username']}"; ?></td>
                        <td><?php echo "{$info['email']}"; ?></td>
                        <td> <?php echo "{$info['password']}"; ?></td>
                        <td>
                            <p class="status delivered"><?php
                echo "<a class='status delivered' style='text-decoration: none;' href='./admin_update_student.php?student_id={$info['id']}'> Update</a>";?></p>
                        </td>
                        <td><p class="status cancelled"><?php
                echo "<a class='status cancelled' style='text-decoration: none;' onClick=\"javascript:return confirm('Are You Sure to Delete this'); \" href='delete.php?student_id={$info['id']}'>Delete</a>"?></p></td>
                    </tr>
                    <?php
                    }
                    ?>
