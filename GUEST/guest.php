    ...
    <article>
      ...
      <section class="section hero has-bg-image" id="home" aria-label="home"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <a href="http://localhost/Masomo/FORMS/Signup.php" class="btn has-before">
      ...
      <section class="section blog has-bg-image" id="blog" aria-label="blog"
        ...
        <div class="container">
          ...
          <h2 class="h2 section-title">Get News With Masomo</h2>
  ...
  <footer class="footer" style="background-image: url('./assets/images/footer-bg.png')">
      ...
      <div class="container grid-list">
        ...
        <div class="footer-brand">
          ...
          <div class="wrapper">
            ...
            <address class="address">70-80 Ruiru Main Campus</address>
          </div>

          <div class="wrapper">
            <span class="span">Call:</span>

            <a href="tel:0794180011" class="footer-link">+01 123 4567 890</a>
          </div>

          <div class="wrapper">
            <span class="span">Email:</span>

            <a href="mailto:eugenegitonga7.com" class="footer-link">info@masomo.com</a>
          </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          Copyright 2024 All Rights Reserved by <a href="#" class="copyright-link">Esther/Eugene</a>
        </p>
