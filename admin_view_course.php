...
session_start();
  ...
  $result2 = mysqli_query($data, $sql);//accessing data in the database
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="./admin_home.php"><i class="fas fa-desktop"></i><span class="navlink">Dashboard</span></a>
        <div class="dropdown">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <img src="<?php echo "{$info['image']}"; ?>"alt=""><?php echo "{$info['name']}"; ?> </td>
                        <td><?php echo "{$info['level']}"; ?></td>
                        <td><?php echo "{$info['description']}"; ?></td>
                        <td>
                            <p class="status delivered"><?php
                echo "<a class='status delivered' style='text-decoration: none;' href='./admin_update_course.php?course_id={$info['id']}'> Update</a>";?></p>
                        </td>
                        <td><p class="status cancelled"><?php
                echo "<a class='status cancelled' style='text-decoration: none;' onClick=\"javascript:return confirm('Are You Sure to Delete this'); \" href='delete_course.php?course_id={$info['id']}'>Delete</a>"?></p></td>
                    </tr>
                    <?php
                    }
                    ?>
