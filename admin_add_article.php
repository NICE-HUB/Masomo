...
error_reporting(E_ALL);
 ...
 if(isset($_POST['add_article'])){
    ...
    move_uploaded_file($_FILES['image']['tmp_name'], $dst);//the first section $_FILES['image']['name'] is the file name then second part $dst is the file destination
        //query
        $sql = "INSERT INTO article (name,description,image) 
                VALUE('$a_name', '$a_desc', '$dst_db')";
        ...
        <div class="login-card">
            ...
            <form action="#" method="POST" class="login-card-form"  enctype="multipart/form-data">
                <div class="form-item">
                    ...
                    <input type="text" name="name" id="emailForm" placeholder="Article name"
                    autofocus required>
                </div>
            
                <div class="form-item">
                    <span class="form-item-icon material-symbols-rounded"></span>
                    <textarea name="description" id="" cols="20" rows="3" placeholder="Please type in the blog"
